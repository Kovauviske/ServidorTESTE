...
if(!((player distance (getMarkerPos "cop_spawn_1") < 120) 
OR  (player distance (getMarkerPos "cop_spawn_2") < 120) 
OR (player distance (getMarkerPos "cop_spawn_3") < 120) 
OR (player distance (getMarkerPos "cop_spawn_4") < 120)
OR (player distance (getMarkerPos "sofia_police") < 120)
OR (player distance (getMarkerPos "cop_spawn_douane") < 120))) then 
{
