...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			...
			case "rabbitgrilled": {"life_inv_rabbitgrilled"};
			case "salemagrilled": {"life_inv_salemagrilled"};
			case "ornategrilled": {"life_inv_ornategrilled"};
			case "mackerelgrilled": {"life_inv_mackerelgrilled"};
			case "tunagrilled": {"life_inv_tunagrilledd"};
			case "mulletfried": {"life_inv_mulletfried"};
			case "catsharkfried": {"life_inv_catsharkfried"};
			case "hengrilled": {"life_inv_hengrilled"};
			case "roostergrilled": {"life_inv_roostergrilled"};
			case "sheepgrilled": {"life_inv_sheepgrilled"};
			case "goatgrilled": {"life_inv_goatgrilled"};			
			...
			case "cana": {"life_inv_cana"};
			case "gas": {"life_inv_gas"};
			case "canap": {"life_inv_canap"};
	...
	case 1:
	{
		switch (_var) do
		{
			...
			case "life_inv_rabbitgrilled": {"rabbitgrilled"};
			case "life_inv_salemagrilled": {"salemagrilled"};
			case "life_inv_ornategrilled": {"ornategrilled"};
			case "life_inv_mackerelgrilled": {"mackerelgrilled"};
			case "life_inv_tunagrilled": {"tunagrilled"};
			case "life_inv_mulletfried": {"mulletfried"};
			case "life_inv_catsharkfried": {"catsharkfried"};
			case "life_inv_hengrilled": {"hengrilled"};
			case "life_inv_roostergrilled": {"roostergrilled"};
			case "life_inv_sheepgrilled": {"sheepgrilled"};
			case "life_inv_goatgrilled": {"goatgrilled"};
			...
			case "life_inv_canau": {"cana"};
			case "life_inv_canap": {"canap"};
			case "life_inv_gasu": {"gas"};
			case "life_inv_gasp": {"gasp"};
