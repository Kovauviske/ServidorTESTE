...
switch (_var) do
{
	...
	case "life_inv_rabbitgrilled": {(localize "STR_Item_rabbitgrilled")};
	case "life_inv_salemagrilled": {(localize "STR_Item_SalemaGrilled")};
	case "life_inv_ornategrilled": {(localize "STR_Item_OrnateGrilled")};
	case "life_inv_mackerelgrilled": {(localize "STR_Item_MackerelGrilled")};
	case "life_inv_tunagrilled": {(localize "STR_Item_TunaGrilled")};
	case "life_inv_mulletfried": {(localize "STR_Item_MulletFried")};
	case "life_inv_catsharkfried": {(localize "STR_Item_CatSharkFried")};
	case "life_inv_hengrilled": {(localize "STR_Item_henGrilled")};
	case "life_inv_roostergrilled": {(localize "STR_Item_roosterGrilled")};
	case "life_inv_sheepgrilled": {(localize "STR_Item_sheepGrilled")};
	case "life_inv_goatgrilled": {(localize "STR_Item_goatGrilled")};
	...
	case "life_inv_canau": {(localize "STR_Item_CanaU")};
	case "life_inv_canap": {(localize "STR_Item_CanaP")};
	case "life_inv_gasu": {(localize "STR_Item_GasU")};
	case "life_inv_gasp": {(localize "STR_Item_GasP")};
	...
	case "life_inv_kidney": {(localize "STR_Shops_orgao")};
	case "life_inv_scalpel": {(localize "STR_scalpel")};
	...
	case "license_adac_car": {(localize "STR_License_Pilot")};
	case "license_adac_air": {(localize "STR_License_Driver")};
	case "license_cop_swat": {(localize "STR_License_Swat")};
	case "license_cop_coastguard": {(localize "STR_License_CG")};
	...
	case "license_civ_cana": {(localize "STR_License_cana")};
	case "license_civ_gas": {(localize "STR_License_gas")};
	case "license_med_air": {(localize "STR_License_Pilot")};
	case "license_civ_home": {(localize "STR_License_Home")};
	case "license_civ_donator": {(localize "STR_License_Donator")};
	case "license_civ_brothers_of_war": {(localize "STR_license_civ_Brothers_of_War")};
};
