...
switch (playerSide) do
{
	...
	case west:
	{
        ...
        life_actions = life_actions + [player addAction["Apreender Objetos",life_fnc_seizeObjects,cursorTarget,0,false,false,"",'(count(nearestObjects [player,["weaponholder"],3])>0)']]; 
	};
};
