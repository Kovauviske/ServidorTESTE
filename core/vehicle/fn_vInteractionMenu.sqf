...
if(playerSide == west) then {
	...
	_Btn5 buttonSetAction "[] spawn life_fnc_impoundAction;";
	
	_Btn6 ctrlSetText localize "STR_vInAct_Impound_keep";
	_Btn6 buttonSetAction "[TRUE] spawn life_fnc_impoundAction;";
