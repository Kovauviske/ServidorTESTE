...
if(leader(group player) != player) exitWith {hint "Vous n'avez pas la capacité de faire ça."};
...
[[_data,_group], "TON_fnc_clientGangLeader",_data,false] spawn life_fnc_MP;
