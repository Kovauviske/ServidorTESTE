...
_price = [_vehicle,__GETC__(life_assur_prices2)] call TON_fnc_index;
if(_price == -1) then {_price = 10000;} else {_price = (__GETC__(life_assur_prices2) select _price) select 1;};
