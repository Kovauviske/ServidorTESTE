...
_price = [_vehicle,__GETC__(life_garage_prices4)] call TON_fnc_index;
if(_price == -1) then {_price = 1000;} else {_price = (__GETC__(life_garage_prices4) select _price) select 1;};
