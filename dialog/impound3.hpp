class Life_impound_menu3
{
	...
	class controlsBackground
	{
		...
		class RentCar : Life_RscButtonMenu
		{
			...
			onButtonClick = "[] call life_fnc_unimpound3;";
		...
		class BuyCar : life_RscButtonMenu 
		{
			...
			onButtonClick = "[] call life_fnc_sellGarage2;";
		...
		class InsureCar : life_RscButtonMenu
		{
			idc = 97480;
			text = "Assurer";
			onButtonClick = "[] call life_fnc_InsureCar2;";
	...
	class controls
	{
		class VehicleList : Life_RscListBox
		{
			...
			onLBSelChanged = "_this call life_fnc_garageLBChange3;";
