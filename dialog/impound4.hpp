class Life_impound_menu4
{
	...
	class controlsBackground
	{
		...
		class RentCar : Life_RscButtonMenu
		{
			...
			onButtonClick = "[] call life_fnc_unimpound4;";
		...
		class BuyCar : life_RscButtonMenu 
		{
			...
			onButtonClick = "[] call life_fnc_sellGarage3;";
		...
		class InsureCar : life_RscButtonMenu
		{
			idc = 97480;
			text = "Assurer";
			onButtonClick = "[] call life_fnc_InsureCar3;";
	...
	class controls
	{
		class VehicleList : Life_RscListBox
		{
			...
			onLBSelChanged = "_this call life_fnc_garageLBChange4;";
