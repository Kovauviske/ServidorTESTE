...
#define IDC_LIFE_PICTURE_RUNNING 1203
...
#define IDC_LIFE_RUNNING_TEXT 1003
	...
	*/
	...
	class LIFE_BAR_RUNNING: Life_RscProgress
	{
		idc = IDC_LIFE_BAR_RUNNING;
		x = 0.938281 * safezoneW + safezoneX;
	...
	class LIFE_RUNNING_TEXT: Life_RscText
	{
		idc = IDC_LIFE_RUNNING_TEXT;
		text = "";
		x = 0.958906 * safezoneW + safezoneX;
	...
	class LIFE_PICTURE_RUNNING: life_RscPicture
	{
		idc = IDC_LIFE_PICTURE_RUNNING;
