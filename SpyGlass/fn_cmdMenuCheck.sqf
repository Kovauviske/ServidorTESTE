...
_validMenus = [
	...
	"RscRadio","RscGroupRootMenu","RscMenuReply","RscMenuReply","RscMenuStatus","","#User:BIS_fnc_addCommMenuItem_menu","RscMenuMove","RscMenuFormations",
	"#User:adminmenu","#USER:adminmenu","#USER:AdminToolsMenu","#USER:ModToolsMenu","#USER:ToolsMenu","#USER:_pmenu"
];
