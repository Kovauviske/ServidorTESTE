/*
	...
	Description:
	Checks for common hack scripts and injectors.
*/
private["_array", "_player", "_hackType", "_hackValue"];
 
diag_log "Linox Anti-hack Mise en Route...";
AHAH = {
    diag_log "ANTI-HACK 0.6.3 Mise en Route...";
    if (isServer) exitWith {};
    _commonPaths = ["used for hacking", "wuat\screen.sqf", "scripts\defaultmenu.sqf", "menu\initmenu.sqf", 
	"scr\exec.sqf", "scripts\exec.sqf", "menu\exec.sqf", "wuat\exec.sqf", "crinkly\keymenu.sqf", "scripts\ajmenu.sqf", 
	"startup.sqf", "wookie_wuat\startup.sqf", "potato.sqf", "1.sqf", "vaa.pbo"
    ]; {
    ...
    diag_log "Linox Anti-hack: Starting loops!";
    [] spawn {
        ...
        _badPublicVariables = ["pic", "veh", "wuat_fpsMonitor", "unitList", "list_wrecked",
                ...
                "lmzsjgnas", "vm", "Monky_hax_toggled", "pu", "nb", "vspeed", "godlol", "aesp", "godall", "initarr3", "initarr2", "DEV_ConsoleOpen", 
				"LOKI_GUI_Key_Color", "fnc_usec_damageHandler", "RGB", "riasgremory_Noobs", "riasgremory_Bitches",
				"riasgremory_Map_Markers", "ThirtySix_Unlim_Ammo", "titles_n_shit", "eXecutorr", "menu_headers",
				"player_list", "refresh_players", "fn_loadMap", "weapon_list", "vehicle_list", "get_display",
				"create_display", "execMapFunc", "mapFunc", "OPEN_LISTS", "init_menu"
        ];
        diag_log "Untouchable Anti-hack: Detection of hack variables started!";
        while {
            true
        }
        do {
    ...
    [] spawn {
        ...
        diag_log "Untouchable Anti-hack: Hack menu check started!";
        while {
            true
        }
        do {
            ...
            if (!(isNull findDisplay 3030) || !(isNull findDisplay 155)) then {
                    ...
                    diag_log "Untouchable Anti-hack: Found a hack menu!";
    ...
    [] spawn {
        ...
        diag_log "Untouchable Anti-hack: Godmode check started!";
        while {
            true
        }
        do {
            if (unitRecoilCoefficient player != _recoilSettings) exitWith {
                    diag_log "Untouchable Anti-hack: Detected recoil hack!";
...
diag_log "Untouchable Anti-hack: Adding public variable handler";
"hackFlag"
...
diag_log "Linox: Le anti-hack est maintenant pret a etre utilisé!";