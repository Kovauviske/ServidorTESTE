if (life_kw_sofia) exitWith {hint "Você já desligou a usina"};
...
if(playerSide == civilian) then
{
	...
	[[0,format["!!! %1 Desligou a Estação de energia de Sofia !!!", name player]],"life_fnc_broadcast",west,false] spawn life_fnc_MP;
	sleep 300;
	life_kw_sofia = false;
};