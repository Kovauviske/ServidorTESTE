if (life_kw_athira) exitWith {hint "Você já desligou a usina"};
...
if(playerSide == civilian) then
{
	...
	[[0,format["!!! %1 Desligou a Estação de Energia de Athira !!!", name player]],"life_fnc_broadcast",west,false] spawn life_fnc_MP;
	sleep 300;
