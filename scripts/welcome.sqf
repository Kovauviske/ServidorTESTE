...
_role1 = "Entre no nosso TS"; //In yellow
_role1names = ["atblife.ts3pro.com"]; //In white
_role2 = "Desenvolvido por:";
_role2names = ["Jacare e Basomga"]; 
_role3 = "Obrigado por jogar conosco!";
_role3names = ["Agradeçemos a você que está diariamente conosco, equipe ATB."];
