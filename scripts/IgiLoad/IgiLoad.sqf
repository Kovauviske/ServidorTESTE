...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
#include <macro.h>
//Checking Level//Medic or Adac?//
  if(FETCH_CONST(life_mediclevel) < 1) exitWith {closeDialog 0;};
//if(FETCH_CONST(life_mediclevel) < 1) exitWith {closeDialog 0;};
//if(FETCH_CONST(life_adaclevel) == 1) exitWith {};
//if(FETCH_CONST(life_adaclevel) == 1) exitWith {closeDialog 0;};
...
if (isnil "IL_Variables") then
{
	...
	IL_Supported_SUV = ["C_SUV_01_F","B_Heli_Light_01_F"];
	...
	IL_Supported_Cargo_Veh_Kamaz = IL_Supported_Quadbike + IL_Supported_Rubberboat + IL_Supported_SDV + IL_Supported_Hatchback + IL_Supported_UGV + IL_Supported_VAN + IL_Supported_SUV + IL_Supported_OFFROAD + IL_Supported_Hunter;
	...
	IL_Supported_Cargo_Veh_HEMTT = IL_Supported_Cargo_Veh_Kamaz + IL_Supported_OFFROAD + IL_Supported_SUV + IL_Supported_Hatchback + IL_Supported_VAN + IL_Supported_Hunter + IL_Supported_Quadbike;
	...
	IL_Supported_Cargo_Veh_Mohawk = IL_Supported_Quadbike + IL_Supported_Rubberboat + IL_Supported_SDV + IL_Supported_Hatchback + IL_Supported_OFFROAD + IL_Supported_SUV + IL_Supported_UGV;
...
//		"('Cargo' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (((getPosATL _target) select 2) >= IL_Para_Jump_ATL) && (_target animationPhase 'ramp_bottom' < 0.1) && (_target getVariable 'usable_ramp')"
	...
	_obj_main addAction [
	"<img image='scriptsIgiLoad\images\unload_para.paa' /><t color=""#b200ff"">  Unload cargo with parachute</t>",
	{
		[_this select 0, true] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
...
if (_obj_main_type in IL_Supported_Vehicles_C17) then
{
	...
	_obj_main addAction [
	"<img image='scripts\IgiLoadd\images\unload_all_para.paa' /><t color=""#a50b00"">  Unload ALL cargo with parachute</t>",
	{
		while {((_this select 0) getVariable "box_num") != 0} do
		{
			[_this select 0, true] call IL_Do_Unload;
...
if (_obj_main_type in IL_Supported_Vehicles_HEMTT) then
{
	...
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Rebocar Veiculo</t>",
	{
	...
	_obj_main addAction [
	"<img image='scripts\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Tirar Veiculo</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
