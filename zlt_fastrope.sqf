...
#define STR_FAST_ROPE "Descer [RAPEL]"
#define STR_CUT_ROPES "Subir Cordas"
...
zlt_rope_helis = ["O_Heli_Light_02_unarmed_F","I_Heli_Transport_02_F","B_Heli_Transport_01_F","I_Heli_light_03_unarmed_F","B_Heli_Light_01_F"];   
